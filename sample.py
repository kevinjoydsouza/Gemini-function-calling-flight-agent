...
def handle_response(response):
    try:
        ...
        if hasattr(first_part, "function_call") and first_part.function_call:
            response_args = first_part.function_call.args or {}
            ...
            # No function call, return plain text response
            return first_part.text if hasattr(first_part, "text") else "No text response available."
